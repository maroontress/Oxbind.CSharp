...
/// elements, which stands for the class corresponding to the child element,
/// and how the child element occurs inside the parent.
/// </summary>
/// <remarks>
/// The <see cref="SchemaType"/> object is immutable, and has a class annotated
/// with <see cref="ForElementAttribute"/> corresponding to the child element.
/// It must be created with one of <see cref="Mandatory.Of{T}()"/>, <see
/// cref="Optional.Of{T}()"/> and <see cref="Multiple.Of{T}()"/>.
/// </remarks>
...
public abstract class SchemaType(Type type, bool isMandatory, bool isMultiple)
{
    ...
    /// The function that returns the metadata corresponding to the specified
    /// class.
    /// </param>
